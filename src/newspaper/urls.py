...
from newspaper.views import NewspaperListView, YearListView, IssueListView, ArticleListView, generate
...
urlpatterns = [
    ...
    url(r'^generate/(?P<np>[\w-]+)/(?P<year>\d+)/(?P<issue>\d+)/$', generate, name='generate'),
